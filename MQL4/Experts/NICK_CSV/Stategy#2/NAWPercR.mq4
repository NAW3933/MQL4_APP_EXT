...
InstrumentProperties::InstrumentProperties(string symbol)
  {
   ...
   if(bAtr1) this.atr1        =iWPR(this.Symbol,PERIOD_M1,period,0);
   if(bAtr5) this.atr5        =iWPR(this.Symbol,PERIOD_M5,period,0);
   if(bAtr15)this.atr15       =iWPR(this.Symbol,PERIOD_M15,period,0);
   if(bAtr30)this.atr30       =iWPR(this.Symbol,PERIOD_M30,period,0);
   if(bAtr1hr)this.atr60       =iWPR(this.Symbol,PERIOD_H1,period,0);
   if(bAtr4hr)this.atr4hr      =iWPR(this.Symbol,PERIOD_H4,period,0);
   if(bAtr1D)this.atr1d       =iWPR(this.Symbol,PERIOD_D1,period,0);
   if(bAtr1w) this.atr1W     =iWPR(this.Symbol,PERIOD_W1,period,0);
