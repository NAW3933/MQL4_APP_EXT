...
InstrumentProperties::InstrumentProperties(string symbol)
  {
   ...
   this.ssl_1d_v1            = iCustom(this.Symbol,PERIOD_D1,"ssl-channel-chart-alert-indicator",8,false,false,false,false,0,0);
   this.ssl_1d_v2             = iCustom(this.Symbol,PERIOD_D1,"ssl-channel-chart-alert-indicator",8,false,false,false,false,1,0);
   this.ssl_1d_v1_Y            = iCustom(this.Symbol,PERIOD_D1,"ssl-channel-chart-alert-indicator",8,false,false,false,false,0,1);
   this.ssl_1d_v2_Y             = iCustom(this.Symbol,PERIOD_D1,"ssl-channel-chart-alert-indicator",8,false,false,false,false,1,1);

   this.ssl_H4_v1            = iCustom(this.Symbol,PERIOD_H4,"ssl-channel-chart-alert-indicator",12,false,false,false,false,0,0);
   this.ssl_H4_v2             = iCustom(this.Symbol,PERIOD_H4,"ssl-channel-chart-alert-indicator",12,false,false,false,false,1,0);
   this.ssl_H4_v1_Y            = iCustom(this.Symbol,PERIOD_H4,"ssl-channel-chart-alert-indicator",12,false,false,false,false,0,1);
   this.ssl_H4_v2_Y             = iCustom(this.Symbol,PERIOD_H4,"ssl-channel-chart-alert-indicator",12,false,false,false,false,1,1);

   this.ssl_H1_v1            = iCustom(this.Symbol,PERIOD_H1,"ssl-channel-chart-alert-indicator",12,false,false,false,false,0,0);
   this.ssl_H1_v2             = iCustom(this.Symbol,PERIOD_H1,"ssl-channel-chart-alert-indicator",12,false,false,false,false,1,0);
   this.ssl_H1_v1_Y            = iCustom(this.Symbol,PERIOD_H1,"ssl-channel-chart-alert-indicator",12,false,false,false,false,0,1);
   this.ssl_H1_v2_Y             = iCustom(this.Symbol,PERIOD_H1,"ssl-channel-chart-alert-indicator",12,false,false,false,false,1,1);

   this.ssl_M30_v1            = iCustom(this.Symbol,PERIOD_M30,"ssl-channel-chart-alert-indicator",12,false,false,false,false,0,0);
   this.ssl_M30_v2             = iCustom(this.Symbol,PERIOD_M30,"ssl-channel-chart-alert-indicator",12,false,false,false,false,1,0);
   this.ssl_M30_v1_Y            =iCustom(this.Symbol,PERIOD_M30,"ssl-channel-chart-alert-indicator",12,false,false,false,false,0,1);
   this.ssl_M30_v2_Y             = iCustom(this.Symbol,PERIOD_M30,"ssl-channel-chart-alert-indicator",12,false,false,false,false,1,1);
