...
InstrumentProperties::InstrumentProperties(string symbol)
  {
   this.Symbol          = symbol;
   this.vwma            = iCustom(this.Symbol,PERIOD_D1,"Nick1\\vwmacg-4c-aa-mtf-tt",7,false,10,6,1,0, 2.618, 1,2,false,1,false,false,false,false,"alert.wav",0,0);
   this.price             = iClose(this.Symbol,PERIOD_D1,0);
   //NULL;//iCustom(this.Symbol,PERIOD_D1,"Custom Moving Averages",4,0,0);
 
   this.vwmaYes         = iCustom(this.Symbol,PERIOD_D1,"nick1\\vwmacg-4c-aa-mtf-tt",7,false,10,6,1,0, 2.618, 1,2,false,1,false,false,false,false,"alert.wav",0,1);
   this.priceYes          = iClose(this.Symbol,PERIOD_D1,1);
   //NULL;// iCustom(this.Symbol,PERIOD_D1,"Custom Moving Averages",4,0,1);

   this.vwma_4h            = iCustom(this.Symbol,PERIOD_H4,"nick1\\vwmacg-4c-aa-mtf-tt",7,false,10,6,1,0, 2.618, 1,2,false,1,false,false,false,false,"alert.wav",0,0);
   this.price_4h             = iClose(this.Symbol, PERIOD_H4,0);
   //NULL;//iCustom(this.Symbol,PERIOD_H4,"Custom Moving Averages",4,0,0);
   
   this.vwmaYes_4h        = iCustom(this.Symbol,PERIOD_H4,"nick1\\vwmacg-4c-aa-mtf-tt",7,false,10,6,1,0, 2.618, 1,2,false,1,false,false,false,false,"alert.wav",0,1);
   this.priceYes_4h          = iClose(this.Symbol, PERIOD_H4,1);
   //NULL;//iCustom(this.Symbol,PERIOD_H4,"Custom Moving Averages",4,0,1);

   this.vwma_1h            = iCustom(this.Symbol,PERIOD_H1,"nick1\\vwmacg-4c-aa-mtf-tt",7,false,10,6,1,0, 2.618, 1,2,false,1,false,false,false,false,"alert.wav",0,0);
   this.price_1h             = iClose(this.Symbol, PERIOD_H1,0);
   //NULL;//iCustom(this.Symbol,PERIOD_H1,"Custom Moving Averages",4,0,0);
   
   this.vwmaYes_1h        = iCustom(this.Symbol,PERIOD_H1,"nick1\\vwmacg-4c-aa-mtf-tt",7,false,10,6,1,0, 2.618, 1,2,false,1,false,false,false,false,"alert.wav",0,1);
   this.priceYes_1h          = iClose(this.Symbol, PERIOD_H1,1);
   //NULL; //iCustom(this.Symbol,PERIOD_H1,"Custom Moving Averages",4,0,1);

   this.vwma_30m            = iCustom(this.Symbol,PERIOD_M30,"nick1\\vwmacg-4c-aa-mtf-tt",7,false,10,6,1,0, 2.618, 1,2,false,1,false,false,false,false,"alert.wav",0,0);
   this.price_30m             = iClose(this.Symbol, PERIOD_M30,0);
   //NULL; //iCustom(this.Symbol,PERIOD_M30,"Custom Moving Averages",4,0,0);
  
   this.vwmaYes_30m        = iCustom(this.Symbol,PERIOD_M30,"nick1\\vwmacg-4c-aa-mtf-tt",7,false,10,6,1,0, 2.618, 1,2,false,1,false,false,false,false,"alert.wav",0,1);
