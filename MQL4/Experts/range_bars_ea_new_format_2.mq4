...
int start() {
   ...
   while (IsStopped() == FALSE) {
      ...
      if (RefreshRates()) {
         ...
         double sclose = Close[0]; if (InvertPrices) sclose=1.0/Close[0];
