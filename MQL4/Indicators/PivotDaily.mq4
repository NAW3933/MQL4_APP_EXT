...
int init()
  {
   ...
   SetIndexStyle(1,DRAW_LINE,0,1,DarkTurquoise);
   SetIndexStyle(2,DRAW_LINE,0,1,Crimson);
   SetIndexStyle(3,DRAW_LINE,0,1,DarkTurquoise);
   SetIndexStyle(4,DRAW_LINE,0,1,Crimson);
   SetIndexStyle(5,DRAW_LINE,0,1,YellowGreen);
   SetIndexStyle(6,DRAW_LINE,0,1,YellowGreen);
