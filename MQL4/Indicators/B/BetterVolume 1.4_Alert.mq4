...
//---- BetterVolume
 //+------------------------------------------------------------------+ 
        string  message  =  StringConcatenate(" BetterVolume (", Symbol(), ", ", Period(), ")  -  BUY!!!" ,"-" ,TimeToStr(TimeLocal(),TIME_SECONDS)); 
        string  message2 =  StringConcatenate(" BetterVolume (", Symbol(), ", ", Period(), ")  -  SELL!!!","-"  ,TimeToStr(TimeLocal(),TIME_SECONDS)); 
               
        if (red[SIGNAL_BAR] != EMPTY_VALUE && red[SIGNAL_BAR] != 0 && SoundBuy)
         {
         SoundBuy = False;
      ...
      if (!SoundBuy && (red[SIGNAL_BAR] == EMPTY_VALUE || red[SIGNAL_BAR] == 0)) SoundBuy = True;  
            
  
     if (white[SIGNAL_BAR] != EMPTY_VALUE && white[SIGNAL_BAR] != 0 && SoundSell)
         {
         SoundSell = False;
      ...
      if (!SoundSell && (white[SIGNAL_BAR] == EMPTY_VALUE || white[SIGNAL_BAR] == 0)) SoundSell = True; 
