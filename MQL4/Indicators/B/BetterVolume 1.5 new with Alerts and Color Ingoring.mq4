...
//----
   ...
   {
      if ((CurrentColor[1] == LightSeaGreen) && (IgnoreLightSeaGreen)) return;
      if ((CurrentColor[1] == White) && (IgnoreWhite)) return;
      if ((CurrentColor[1] == FireBrick) && (IgnoreFireBrick)) return;
      if ((CurrentColor[1] == DodgerBlue) && (IgnoreDodgerBlue)) return;
      if ((CurrentColor[1] == LightSalmon) && (IgnoreLightSalmon)) return;
      if ((CurrentColor[1] == Magenta) && (IgnoreMagenta)) return;
