...
else
{
   ...
   xposTAG = 10 ;
         ...
         ObjectSetText(TAG+"HD1","BCDRW" ,8,"Tahoma",TextColor);
...
*/         
   ...
   CustomName = "BetterVol_CDRW_Alert_TRO_MODIFIED_VERSION"; 
   
   BCDRW = iCustom(symbol, tframe[x], CustomName, MAPeriod,LookBack,Offset,   3,0);       
...
"shift " , shift , "\n" ,
"tframe[x] " , tframe[x] , "\n" ,
"BCDRW " , DoubleToStr(BCDRW,Digits) , "\n" ,
