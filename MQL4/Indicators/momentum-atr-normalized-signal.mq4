...
int start()
{
   ...
   {
      double atr    = iATR(sSymbol,iTF,momPeriod,i);
      double price1 = iMA(sSymbol,iTF,momSmooth,0,MODE_SMA,momPrice,i);
      double price2 = iMA(sSymbol,iTF,momSmooth,0,MODE_SMA,momPrice,i+momPeriod);
         if (atr!=0)
