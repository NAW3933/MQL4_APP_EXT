...
//|                                                                  |
//|             March 20/2008 Added separate window & histogram mode |
//|                                         GoingForward - Forex-Tsd |
//+------------------------------------------------------------------+
...
extern int     Length         = 25;  //Period of NonLagMA
...
bool   UpTrendAlert=true, DownTrendAlert=true;
//+------------------------------------------------------------------+
...
//---- name for DataWindow and indicator subwindow label
   short_name="NonLagMA_Hist("+Length+")";
   IndicatorShortName(short_name);
   SetIndexLabel(0,"NonLagMA_Hist");
   SetIndexLabel(1,"Up");
   SetIndexLabel(2,"Dn");
//----
