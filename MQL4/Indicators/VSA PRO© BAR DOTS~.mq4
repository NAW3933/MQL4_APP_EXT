/*
   ...
   Website: HT tP:/ /WW w.me t aq uoTES.neT
   E-mail :  SuP PO R T @m E Ta Qu Ot es.nE T
*/
...
int start() {
   ...
   for (int count_0 = 0; count_0 < Li_4; count_0++) {
      ...
      Ld_20 = (High[count_0 + 1] + (Low[count_0 + 1])) / 2.0 + (High[count_0 + 1] - (Low[count_0 + 1])) / 3.4;
      Ld_28 = (High[count_0 + 1] + (Low[count_0 + 1])) / 2.0 - (High[count_0 + 1] - (Low[count_0 + 1])) / 3.4;
