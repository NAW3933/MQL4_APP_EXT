...
int		CSignalTimeRange::Init(int startHour, int startMinute, int endHour, int endMinute,  bool checkInside=true) {
   ...
   if(!(0<=startMinute && startMinute<=59))
      return (InitError("Start hour must be from 0-59", INIT_FAILED));
